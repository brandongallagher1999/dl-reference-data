enum DosageFormQueries {
  ...
  CREATE = "INSERT INTO public.refdata_dosage_forms (name, dosage_form_type_id) VALUES($1, $2)",
  UPDATE = 'UPDATE public.refdata_dosage_forms SET "name"=$1, dosage_form_type_id=$2 WHERE id=$3',
}
